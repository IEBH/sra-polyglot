...
exports.default = {
    ...
    */
    compile: function compile(tree, options) {
        ...
        if (settings.replaceWildcards) _tools2.default.replaceContent(tree, ['phrase'], [{ subject: /#/g, value: '<span msg="NO_SINGLE_WILDCARD">*</span>' }, { subject: /\?/g, value: '#' }, { subject: /\$/g, value: '*' }]);
                ...
                switch (branch.type) {
                    ...
                    case 'phrase':
                        if (branch.field && (branch.field == 'title+abstract' || branch.field == 'title+abstract+tw')) {
                            ...
                            buffer += _lodash2.default.trimStart((branch.field == 'title' ? 'TI' : branch.field == 'abstract' ? 'AB' : branch.field == 'floatingSubheading' ? 'MW' : branch.field == 'publicationType' ? 'PT' : branch.field == 'substance' ? 'MW' : '') + ' ' + _tools2.default.quotePhrase(branch, 'cinahl', settings.highlighting));
                        } else {
