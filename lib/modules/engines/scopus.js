...
exports.default = {
    ...
    */
    compile: function compile(tree, options) {
        ...
        if (settings.replaceWildcards) _tools2.default.replaceContent(tree, ['phrase'], [{ subject: /\?/g, value: '<span msg="NO_OPTIONAL_WILDCARD">?</span>' }, { subject: /\$/g, value: '<span msg="NO_OPTIONAL_WILDCARD">*</span>' }, { subject: /#/g, value: '<span msg="NO_SINGLE_WILDCARD">?</span>' }]);
