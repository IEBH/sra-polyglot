        ...
        var compileWalker = function compileWalker(tree) {
            ...
            return tree.map(function (branch, branchIndex) {
                ...
                switch (branch.type) {
                    ...
                    case 'meshMajor':
                        if (settings.highlighting) {
                            buffer += _tools2.default.createTooltip('<font color="blue">' + "'" + branch.content + "'/exp/" + 'mj' + '</font>', "Polyglot does not translate subject terms (e.g MeSH to Emtree), this needs to be done manually");
                        } else {
