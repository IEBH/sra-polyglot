...
describe('Translate floating subheading searches (PubMed -> *)', ()=> {
	...
	it('translate `term1[sh]` -> EM `term1:fs`', ()=> {
		expect(polyglot.translate('term1[sh]', 'embase')).to.equal('term1:lnk');
	});

	it('translate `term1[sh]` -> CI `TI term1`', ()=> {
