...
describe('Translate adjacency searches (ADJ format)', function() {
	...
	it('translate `term1 ADJ3 term2` -> PY `term1 ADJ3 term2`', function() {
...
describe('Translate adjacency searches (NEAR3 format)', function() {
	...
	it('translate `term1 NEAR3 term2` -> PY `term1 ADJ3 term2`', function() {
...
describe('Translate adjacency searches (NEAR/3 format)', function() {
	...
	it('translate `term1 NEAR/3 term2` -> PY `term1 ADJ3 term2`', function() {
...
describe('Translate adjacency searches (N3 format)', function() {
	...
	it('translate `term1 N3 term2` -> PY `term1 ADJ3 term2`', function() {
