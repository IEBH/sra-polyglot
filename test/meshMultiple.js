...
describe('Translate multiple MESH terms (PubMed -> *)', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> PM `"term1 term2"[Mesh]`', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> OV `exp term1 term2/`', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> CO `[mh "term1 term2"]`', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> EM `"term1 term2"/exp`', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> CI `(MH "term1 term2+")`', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> PY `"term1 term2"`', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> SC `INDEXTERMS(term1 term2)`', ()=> {
	...
	it('translate PM `"term1 term2"[Mesh]` -> WS `"term1 term2"`', ()=> {
...
describe('Translate multiple MESH terms (PubMed (short) -> *)', ()=> {
	...
	it('translate PM `"term1 term2"[mh]` -> PM `"term1 term2"[Mesh]`', ()=> {
	...
	it('translate PM `"term1 term2"[mh]` -> OV `exp term1 term2/`', ()=> {
		expect(polyglot.translate('"term1 term2"[mh]', 'ovid')).to.equal('exp term1 term2/');
		expect(polyglot.translate('"term1 and term2"[mh]', 'ovid')).to.equal('exp term1 and term2/');
	});

	it('translate PM `"term1 term2"[mh]` -> CO `[mh "term1 term2"]`', ()=> {
	...
	it('translate PM `"term1 term2"[mh]` -> EM `"term1 term2"/exp`', ()=> {
	...
	it('translate PM `"term1 term2"[mh]` -> CI `(MH "term1 term2+")`', ()=> {
	...
	it('translate PM `"term1 term2"[mh]` -> PY `"term1 term2"`', ()=> {
	...
	it('translate PM `"term1 term2"[mh]` -> SC `INDEXTERMS(term1 term2)`', ()=> {
	...
	it('translate PM `"term1 term2"[mh]` -> WS `"term1 term2"`', ()=> {
...
describe('Translate multiple MESH terms (Ovid -> *)', ()=> {
	...
	it('translate OV `exp term1 term2/` -> PM `"term1 term2"[Mesh]`', ()=> {
	...
	it('translate OV `exp term1 term2/` -> OV `exp term1 term2/`', ()=> {
	...
	it('translate OV `exp term1 term2/` -> CO `[mh "term1 term2"]`', ()=> {
	...
	it('translate OV `exp term1 term2/` -> EM `"term1 term2"/exp`', ()=> {
	...
	it('translate OV `exp term1 term2/` -> CI `(MH "term1 term2+")`', ()=> {
	...
	it('translate PM `exp term1 term2/` -> PY `"term1 term2"`', ()=> {
	...
	it('translate PM `exp term1 term2/` -> SC `INDEXTERMS(term1 term2)`', ()=> {
	...
	it('translate OV `exp term1 term2/` -> WS `"term1 term2"`', ()=> {
