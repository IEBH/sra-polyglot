...
describe('Translate multiple MESH terms (PubMed -> *)', ()=> {
	...
	it('translate `"term1 term2"[Mesh]` -> PY `"term1 term2"`', ()=> {
		expect(polyglot.translateGeneric('"term1 term2"[Mesh]', 'PsycInfo (Ovid)')).to.equal('exp "term1 term2"/');
		expect(polyglot.translateGeneric('"term1 and term2"[Mesh]', 'PsycInfo (Ovid)')).to.equal('exp "term1 and term2"/');
	});
...
describe('Translate multiple MESH terms (PubMed (short) -> *)', ()=> {
	...
	it('translate `"term1 term2"[mh]` -> PY `"term1 term2"`', ()=> {
		expect(polyglot.translateGeneric('"term1 term2"[mh]', 'PsycInfo (Ovid)')).to.equal('exp "term1 term2"/');
		expect(polyglot.translateGeneric('"term1 and term2"[mh]', 'PsycInfo (Ovid)')).to.equal('exp "term1 and term2"/');
	});
...
describe('Translate multiple MESH terms (PubMed (long) -> *)', ()=> {
	...
	it('translate `"term1 term2"[MeSH Terms]` -> PY `"term1 term2"`', ()=> {
		expect(polyglot.translateGeneric('"term1 term2"[MeSH Terms]', 'PsycInfo (Ovid)')).to.equal('exp "term1 term2"/');
		expect(polyglot.translateGeneric('"term1 and term2"[MeSH Terms]', 'PsycInfo (Ovid)')).to.equal('exp "term1 and term2"/');
	});
...
describe('Translate multiple MESH terms (Ovid MEDLINE -> *)', ()=> {
	...
	it('translate `exp term1 term2/` -> PY `"term1 term2"`', ()=> {
		expect(polyglot.translateGeneric('exp term1 term2/', 'PsycInfo (Ovid)')).to.equal('exp "term1 term2"/');
		expect(polyglot.translateGeneric('exp term1 and term2/', 'PsycInfo (Ovid)')).to.equal('exp "term1 and term2"/');
		expect(polyglot.translateGeneric('exp "term1 and term2"/', 'PsycInfo (Ovid)')).to.equal('exp "term1 and term2"/');
	});
